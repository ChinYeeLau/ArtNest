	...
	<header class="clearfix">
		<div class="container">	
			<div class="company-address">
				<h2 class="title">ArtNest</h2>
				<p>
					ArtNest,address<br>
					Artnest 85004, Malaysia
				</p>
			</div>
			<div class="company-contact">
				...
				<div class="email right">
					...
					<a href="mailto:company@example.com">artnest@info.com</a>
					<span class="helper"></span>
				</div>
			</div>
		</div>
        ...
        foreach($orderDetails['orders_products'] as $product){
           $invoiceHTML .='
            ...
            <td class="qty">'.$product['product_qty'].'</td>
						<td class="unit">RM '.$product['product_price'].'</td>
          ...
          $invoiceHTML .='
            ...
            if($orderDetails['coupon_amount']>0){
              $invoiceHTML .='  <td class="total">RM '.$orderDetails['coupon_amount'].'</td>';
          }else{
              $invoiceHTML .='  <td class="total">RM 0</td>';
          }
          $invoiceHTML .=' 
          </tr>
						<tr>
              ...
              <td class="desc"></td>  
							...
							<td class="total">RM '.$orderDetails['grand_total'].'</td>
						</tr>
					</tbody>
				</table>
			</div>
