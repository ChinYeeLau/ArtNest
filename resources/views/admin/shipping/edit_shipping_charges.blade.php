            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h4 class="font-weight-bold">Shipping Management</h4>
                        <h6 class="font-weight-normal mb-0">Shipping Charges</h6>
                    </div>
                ...
                @endif
                  <form class="forms-sample"  action="{{url('admin/edit-shipping-charges/'.$shippingDetails['id'])}}" method="post" enctype="multipart/form-data" >@csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="{{$shippingDetails['state']}}" reaadonly="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="501_1000g" >Rate(501g-1000g)</label>
                      ...
                      <div class="form-group">
                        <label for="2001_5000g" >Rate(2001g-5000g)</label>
