    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
                                ...
                                <tr>
    								...
    								<td class="text-center">RM {{$product['product_price']}}</td>
                                    <td class="text-center">{{$product['product_qty']}}</td>
    								<td class="text-center">RM {{$product['product_price']*$product['product_qty']}}</td>
    							...
    							<tr>
    								...
    								<td class="thick-line text-center">RM {{$subTotal}}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-center">RM 0</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-center"><strong>RM {{$orderDetails['grand_total']}}</strong><br>
                                    @if ($orderDetails['payment_method']=="COD")<font color=red>Already Paid </font>
                                     @endif
                                    </td>
    							</tr>
    						</tbody>
