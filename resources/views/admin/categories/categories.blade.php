            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="max-width:150px; float:right; display:inlineblock;" href="{{url('admin/add-edit-category')}}" class="btn btn-block btn-primary ">Add Categories</a>
                        ...
                        <div class="table-responsive pt-3">
                            <table id="categories" class="table table-bordered">
                                ...
                                <tbody>
                                   ...
                                   @php $parent_category=
                                    $category['parentcategory']['category_name']; @endphp
                                    @else
