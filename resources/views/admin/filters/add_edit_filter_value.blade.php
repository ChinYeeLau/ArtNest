<?php use App\Http\Controllers\Admin\Section; ?>
            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h4 class="font-weight-bold">Filter Values Management</h4>
                        <h6 class="font-weight-normal mb-0">s</h6>
                    </div>
                ...
                @endif
                  ...
                  <form class="forms-sample" @if(empty($filter['id'])) action="{{url('admin/add-edit-filter-value')}}" @else action="{{url('admin/add-edit-filter-value/'.$filter['id'])}}"  @endif method="post" enctype="multipart/form-data" >@csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"id="filter_value" placeholder="Enter Filter Name" name="filter_value" @if(!empty($filter['filter_value'])) value="{{$filter['filter_value']}}"@else value="{{old('filter_value')}}" @endif >
                    </div>
