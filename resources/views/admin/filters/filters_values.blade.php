            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a style="max-width:150px; float:right; display:inlineblock;" href="{{url('admin/filters')}}" class="btn btn-block btn-primary ">View Filters</a>
                        <a style="max-width:150px; float:left; display:inlineblock;" href="{{url('admin/add-edit-filter-value')}}" class="btn btn-block btn-primary ">Add Filter Values</a>       
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            $filter_id = $filter['filter_id']; // Assuming $filter['filter_id'] contains the filter ID
                                            $filterName = ProductsFilter::getFilterName($filter_id);
                                            echo $filterName;
                                            ?>
                                        </td>
                                        <td>
