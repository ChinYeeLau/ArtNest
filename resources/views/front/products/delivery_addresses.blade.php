...
<div style="float:left;margin-right:8px;"><input type="radio" ></div>
<div id="address{{$address['id']}}" name="address_id" value="{{$address['id']}}"><label >{{$address['name']}}, {{$address['address']}}, {{$address['state']}}, {{$address['postcode']}} ({{$address['mobile']}})</label>
