            ...
            <div class="w-75">
                ...
                <div style="padding-top:20px;">
                    <div class="card-body p-5 text-center">
                        ...
                        <form id="vendorForm" action="javascript:;" method="POST">@csrf
                            <div class="form-outline mb-2" style="text-align: left !important;">
                                <label class="form-label" for="vendor-name">Vendor Name</label>
                                <input type="text" name="name" id="vendor-name" placeholder="Vendor Name" class="form-control form-control-lg" />
                                <p id="register-name"></p>
                            </div>
                            <div class="form-outline mb-2" style="text-align: left !important;">
                                <label class="form-label" for="vendor-mobile">Mobile</label>
                                <input type="text" name="mobile" id="vendor-mobile" placeholder="Vendor Mobile" class="form-control form-control-lg" />
                                <p id="register-mobile"></p>
                            </div>
                            <div class="form-outline mb-2" style="text-align: left !important;">
                                <label class="form-label" for="vendor-email">Email</label>
                                <input type="email" name="email" id="vendor-email" placeholder="vendor@vendor.com" class="form-control form-control-lg" />
                                <p id="register-email"></p>
                            </div>
                            <div class="form-outline mb-2" style="text-align: left !important;">
                                <label class="form-label" for="vendor-password">Password</label>
                                <input type="password" name="password" id="vendor-password" placeholder="Vendor Password" class="form-control form-control-lg" /> 
                            ...
                            <div class="form-check d-flex justify-content-start">
                                ...
                                <label class="form-check-label" for="accept">I've read and accept the 
                                    <a href="terms-and-conditions.html" class="red-text">Terms & Conditions</a>
                                </label>
                            </div>
                            ...
                            <div style="text-align: start; padding-top: 10px;"> 
                                <a href="{{ url('vendor/login') }}" style="color:darkorange !important;">Already have an account?</a>
                            </div>
                        </form>
                    </div>
                </div>
